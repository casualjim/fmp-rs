...
impl ListArgs {
    pub async fn handle(&self, ctx: &Context) -> Result<()> {
        let params = match &self.symbol {
            Some(symbol) => fmp::types::crypto::CryptoSymbolParams::builder()
                .symbol(symbol)
                .build(),
            None => fmp::types::crypto::CryptoSymbolParams::builder()
                .symbol("")
                .build(),
        };
...
impl QuoteBatchArgs {
    pub async fn handle(&self, ctx: &Context) -> Result<()> {
        let params = match self.short {
            Some(short) => fmp::types::crypto::CryptoBatchParams::builder()
                .short(short)
                .build(),
