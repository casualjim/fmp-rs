...
fn parse_date_range(from: Option<&str>, to: Option<&str>) -> Result<fmp::types::economics::DateRangeParams> {
...
pub struct IndicatorsArgs {
  #[arg(
    long,
    required = true,
    help = "Indicator name (e.g., GDP, CPI, unemploymentRate, retailSales)"
  )]
  pub name: String,
