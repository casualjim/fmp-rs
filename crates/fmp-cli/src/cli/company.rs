...
impl ProfileCikArgs {
  pub async fn handle(&self, ctx: &Context) -> Result<()> {
    let params = fmp::types::company::CikParams::builder().cik(&self.cik).build();
...
pub struct ExecutivesArgs {
  ...
  #[arg(
    long,
    help = "Filter by active status: \"true\" for current executives, \"false\" for former"
  )]
  ...
  pub async fn handle(&self, ctx: &Context) -> Result<()> {
    let params = match (&self.page, &self.limit) {
      (Some(page), Some(limit)) => fmp::types::company::ShareFloatAllParams::builder()
        ...
        .limit(*limit)
        .build(),
      (Some(page), None) => fmp::types::company::ShareFloatAllParams::builder().page(*page).build(),
...
pub struct MaLatestArgs {
  #[arg(
    long,
    default_value = "0",
    help = "Zero-indexed page number for pagination (default: 0)"
  )]
  pub page: u32,
}
...
impl MaLatestArgs {
  pub async fn handle(&self, ctx: &Context) -> Result<()> {
    let params = fmp::types::company::PaginationParams::builder().page(self.page).build();
...
pub struct MaSearchArgs {
  #[arg(
    long,
    required = true,
    help = "Partial or full company name to search M&A events (acquiring or target)"
  )]
  pub name: String,
}
...
impl MaSearchArgs {
  pub async fn handle(&self, ctx: &Context) -> Result<()> {
    let params = fmp::types::company::MnaSearchParams::builder().name(&self.name).build();
  ...
  pub async fn handle(&self, ctx: &Context) -> Result<()> {
    let params = match (&self.page, &self.limit) {
      (Some(page), Some(limit)) => fmp::types::company::PaginationParams::builder()
        ...
        .limit(*limit)
        .build(),
      (Some(page), None) => fmp::types::company::PaginationParams::builder().page(*page).build(),
      (None, Some(limit)) => fmp::types::company::PaginationParams::builder().limit(*limit).build(),
